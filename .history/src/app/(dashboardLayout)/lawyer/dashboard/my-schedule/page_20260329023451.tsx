...
export default function MySchedulePage() {
  ...
  const { data: schedules = [], isLoading, isError, refetch } = useQuery<LawyerSchedule[]>({
    ...
    enabled: !!user?.id,
    queryFn: async () => {
      const res = await apiClient.get("/lawyer-schedules/my-lawyer-schedules");
  ...
  const createMutation = useMutation({
    mutationFn: async () => {
      const res = await apiClient.post("/lawyer-schedules/create-my-lawyer-schedule", {
  ...
  const updateMutation = useMutation({
    mutationFn: async () => {
      const res = await apiClient.patch("/lawyer-schedules/update-my-lawyer-schedule", {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (scheduleId: string) => {
      const res = await apiClient.delete(`/lawyer-schedules/delete-my-lawyer-schedule/${scheduleId}`);
      return res.data;
    },
