...
export default function ScheduleManagement() {
  ...
  const [newSchedule, setNewSchedule] = useState({ startDateTime: "", endDateTime: "" });
    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-6 flex gap-2">
        ...
        <input
          ...
          className="border p-2 rounded flex-1"
        />
        <button onClick={() => createMutation.mutate()} className="bg-blue-600 text-white px-4 py-2 rounded">
          Create
        </button>
      </div>
