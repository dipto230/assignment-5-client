    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <div className="w-1/3 p-8 bg-gray-50">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input name="consultationFee" type="number" placeholder="Consultation Fee" value={form.consultationFee} onChange={handleChange} className="w-full border p-2 rounded" />
          ...
          <button type="submit" className="bg-primary text-white px-4 py-2 rounded mt-4 w-full">
            Create
          </button>
        </form>
      </div>
