...
export default function NGOPage() {
  ...
  return (
    <main ref={sectionRef} className="bg-white text-gray-900">

      {/* HERO */}
      <section className="py-32 text-center px-6">
        <p className="fade text-xs tracking-[6px] text-[#b89b72] uppercase mb-6">
          NGO
        </p>

        <h1 className="fade text-4xl md:text-6xl font-serif leading-tight mb-6">
          Justice Beyond <br /> Boundaries
        </h1>

        <p className="fade max-w-2xl mx-auto text-gray-600 text-lg mb-10">
          We provide free legal support to those who cannot afford it,
          ensuring equal access to justice for every individual.
        </p>

        <button className="fade border border-[#b89b72] text-[#b89b72] px-10 py-4 rounded-full hover:bg-[#b89b72] hover:text-white transition">
          Support Our Mission
        </button>
      </section>
      ...
      <section className="py-28 px-6 max-w-5xl mx-auto text-center">
        <h2 className="fade text-3xl md:text-4xl font-serif mb-6">
          Who We Are
        </h2>

        <p className="fade text-gray-600 leading-relaxed text-lg">
      ...
      <section className="py-28 px-6 max-w-6xl mx-auto">
        <h2 className="fade text-3xl md:text-4xl font-serif text-center mb-16">
          What We Do
        </h2>
      ...
      <section className="py-32 text-center border-t border-gray-200 px-6">
        ...
        <p className="fade text-gray-600 mb-10">
          Join us in making justice accessible for everyone.
        </p>

        <button className="fade bg-[#b89b72] text-white px-10 py-4 rounded-full hover:opacity-90 transition">
          Become a Volunteer
        </button>
      </section>
