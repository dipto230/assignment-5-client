  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 rounded-3xl overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.15)] bg-white">
        ...
        {/* LEFT IMAGE */}
        <div className="relative min-h-[500px] md:min-h-full group">
          <Image
            src="/images/team.jpg.jpg"
            alt="team"
            fill
            priority
            className="object-cover brightness-110 contrast-110 transition duration-700 group-hover:scale-105 img"
          />
        ...
        <div className="relative p-10 md:p-16 bg-white/80 backdrop-blur-md border-l border-gray-200">
          ...
          <div>
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="fade bg-[#8b6b4a] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#6f5438] transition"
              >
                Submit
              </button>
            </form>
