    ...
    <section className="py-20 bg-linear-to-b from-white to-gray-100">
      ...
      <div className="flex flex-wrap justify-center gap-6 max-w-4xl mx-auto">
        ...
        {data.slice(0, 6).map((item: any, index) => (
          ...
          >
            {/* Glow effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500/0 to-indigo-500/0 group-hover:from-blue-500/10 group-hover:to-indigo-500/10 transition duration-500"></div>
