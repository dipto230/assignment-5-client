...
const Navbar = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      // 👉 later route or state use korte parba
    } catch (err) {
      console.error(err);
    }
  };
      ...
      >
        ...
        <div className="hidden md:flex gap-6 text-sm font-medium items-center">
          ...
          <input
            ...
            className="px-4 py-1.5 rounded-full border text-sm outline-none focus:ring-2 focus:ring-blue-500"
          />
